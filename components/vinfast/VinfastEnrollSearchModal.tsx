...
export default function VinfastEnrollSearchModal({
  open,
  onClose,
  enrolledLocationIds,
  enrollingLocationId,
  ...
  return (
    ...
    >
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="vinfast-enroll-modal-title"
      ...
      >
        <div className="border-b border-arctic-200 px-4 py-3">
          <h2 id="vinfast-enroll-modal-title" className="text-base font-semibold text-onix-900">
            Enroll shop in VinFast
          </h2>
        ...
        <div className="flex items-center gap-2 border-b border-arctic-200 px-4 py-3">
          ...
          <input
            ref={inputRef}
            id="vinfast-enroll-search"
            name="vinfast_enroll_search_query"
            type="search"
            inputMode="search"
            enterKeyHint="search"
            aria-autocomplete="list"
            aria-controls="vinfast-enroll-results"
        ...
        <div id="vinfast-enroll-results" className="max-h-[min(420px,55vh)] overflow-y-auto">
          {loading && (
